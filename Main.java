...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // URL文字列
            String str = "https://lightbox.sakura.ne.jp/demo/json/post-test.php";
            ...
            sb.setLength(0);
            sb.append(String.format("subject=%s", URLEncoder.encode("件名", "utf-8") ));
            sb.append(String.format("&name=%s", URLEncoder.encode("鈴木 次郎", "utf-8") ));
            sb.append(String.format("&text=%s", URLEncoder.encode("ようこそ\r\nよろしくお願いいたします", "utf-8") ));
            sb.append(String.format("&send=%s", URLEncoder.encode("送信ボタン", "utf-8") ));
            sb.append(String.format("&datetime=%s", URLEncoder.encode("2020/11/04 00:00:00", "utf-8") ));
